Public Class anexo1
    Private Sub anexo1_Load(sender As Object, e As EventArgs)
    ...
    Private Sub File_TextChanged(sender As Object, e As EventArgs) Handles File.TextChanged

    End Sub

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Me.Close()
        particularidades.Show()
    End Sub
